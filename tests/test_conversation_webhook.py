...
TEST_CONVERSATION_WEBHOOK_CREATE_RESPONSE = """{
  "id": "20c308852190485bbb658e43baffc5fa",
  "url": "https://example.com",
  "channelId": "c0dae31e440145e094c4708b7d908842",
  "events": [
    "conversation.created",
    "conversation.updated"
  ],
  "status": "enabled",
  "createdDatetime": "2019-04-03T07:46:37.984026573Z",
  "updatedDatetime": null
}"""

TEST_CONVERSATION_WEBHOOK_LIST_PAGINATION_RESPONSE = """{
  "offset": 0,
  "limit": 10,
  "count": 2,
  "totalCount": 2,
  "items": [
    ...
    },
    {
      ...
      "contact": {
        "id": "459a35432b0c4195abbdae353eb19359",
        "href": "https://contacts.messagebird.com/v2/contacts/459a35432b0c4195abbdae353eb19359",
        "msisdn": 31615164888,
        "displayName": "31615164888",
        "firstName": "",
        "lastName": "",
        "customDetails": {},
        "attributes": {},
      ...
      "status": "active",
      "createdDatetime": "2019-04-02T08:19:37Z",
      "updatedDatetime": "2019-04-03T07:35:47.35395356Z",
...
TEST_CONVERSATION_WEBHOOK_LIST_RESPONSE = """{
  "offset": 0,
  "limit": 10,
  "count": 2,
  "totalCount": 2,
...
TEST_CONVERSATION_WEBHOOK_READ_RESPONSE = """{
  "id": "5031e2da142d401c93fbc38518ebb604",
  "url": "https://example.com",
  "channelId": "c0dae31e440145e094c4708b7d908842",
  "events": [
    "conversation.created",
  ...
  "status": "enabled",
  "createdDatetime": "2019-04-03T08:41:37Z",
  "updatedDatetime": null
}"""
...
class TestConversationWebhook(unittest.TestCase):
    ...
    def test_conversation_webhook_create(self):
        http_client = Mock()
        http_client.request.return_value = TEST_CONVERSATION_WEBHOOK_CREATE_RESPONSE
    ...
    def test_conversation_webhook_list(self):
        http_client = Mock()
        http_client.request.return_value = TEST_CONVERSATION_WEBHOOK_LIST_RESPONSE
    ...
    def test_conversation_webhook_read(self):
        http_client = Mock()
        http_client.request.return_value = TEST_CONVERSATION_WEBHOOK_READ_RESPONSE
