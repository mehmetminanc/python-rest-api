...
TEST_MESSAGE_LIST_RESPONSE = """{
  ...
  "items": [
    {
      "originator": "TEST",
      "body": "This is a test message, sent through the MessageBird API, using the official Python SDK.",
      "direction": "mt",
      "mclass": 1,
      "reference": null,
        ...
        "items": [
          {
            "originator": null,
            "status": "delivered",
            "statusDatetime": "2018-07-13T10:34:13+00:00",
            "recipient": 123456789011
          }
        ]
      },
      "validity": null,
      "gateway": 1,
      "typeDetails": {},
      "href": "https://rest.messagebird.com/messages/first-message-id",
      "datacoding": "plain",
      "scheduledDatetime": null,
      "type": "sms",
      "id": "first-message-id"
    },
    {
        ...
        "items": [
          {
            "originator": null,
            "status": "delivered",
            "statusDatetime": "2018-07-13T10:33:56+00:00",
      ...
      "gateway": 1,
      "typeDetails": {},
      "href": "https://rest.messagebird.com/messages/second-message-id",
      "datacoding": "plain",
      "scheduledDatetime": null,
      "type": "sms",
...
TEST_SCHEDULED_MESSAGES_RESPONSE = """{
  "offset": 0,
  "limit": 20,
  "count": 2,
  "totalCount": 2,
...
class TestMessage(unittest.TestCase):
    ...
    def test_message(self):
        http_client = Mock()
        http_client.request.return_value = TEST_MESSAGE_RESPONSE
    ...
    def test_message_list(self):
        http_client = Mock()
        http_client.request.return_value = TEST_MESSAGE_LIST_RESPONSE
    ...
    def test_scheduled_message_list(self):
        http_client = Mock()
        http_client.request.return_value = TEST_SCHEDULED_MESSAGES_RESPONSE
