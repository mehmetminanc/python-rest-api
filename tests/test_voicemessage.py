...
TEST_VOICE_MESSAGE_RESPONSE = """{
  "body": "Hello World",
  "createdDatetime": "2015-01-05T16:11:24+00:00",
  "href": "https://rest.messagebird.com/voicemessages/voicemessage-id",
  "id": "voicemessage-id",
  "ifMachine": "continue",
  "language": "en-gb",
...
TEST_VOICE_MESSAGE_LIST_RESPONSE = """{
  "offset": 0,
  "limit": 10,
  "count": 2,
  "totalCount": 2,
...
class TestVoicemessage(unittest.TestCase):
    ...
    def test_voicemessage(self):
        http_client = Mock()
        http_client.request.return_value = TEST_VOICE_MESSAGE_RESPONSE
