...
TEST_GET_NUMBERS_LIST_RESPONSE = """{
    "data": [
        {
...
class TestCallFlow(unittest.TestCase):
    ...
    def test_get_flow(self):
        http_client = Mock()
        http_client.request.return_value = TEST_GET_FLOW_RESPONSE
    ...
    def test_get_flow_list(self):
        http_client = Mock()
        http_client.request.return_value = TEST_GET_FLOW_LIST
    ...
    def test_numbers_list(self):
        http_client = Mock()
        http_client.request.return_value = TEST_GET_NUMBERS_LIST_RESPONSE
